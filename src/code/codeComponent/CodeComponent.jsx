...
import Prism from "prismjs";
import { slugify } from "../../docs/slugify";
...
function CodeComponent({
  ...
  const componentId = heading ? slugify(heading) : undefined;
  ...
  return (
    <div id={componentId} className="relative rounded-xl border border-gray-700 bg-gray-900 p-5 space-y-3 mb-5">
      ...
      {/* Code */}
      <pre
        className={`line-numbers language-${language} rounded-lg overflow-x-auto`}
      >
        <code
          ref={codeRef}
          className={`language-${language} text-sm`}
